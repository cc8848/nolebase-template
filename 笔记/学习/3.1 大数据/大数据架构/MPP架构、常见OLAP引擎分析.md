- [MPP架构、常见OLAP引擎分析_一个写湿的程序猿的博客-CSDN博客_mpp引擎](https://qinjl.blog.csdn.net/article/details/120494840)
...
二者有许多相似之处，首先`NUMA`和`MPP`都是由多个节点组成的；其次每个节点都有自己的CPU，内存，I/O等；都可以都过节点互联机制进行信息交互。
