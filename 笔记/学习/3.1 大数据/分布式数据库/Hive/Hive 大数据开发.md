...
- [hive表如何删除部分数据](https://blog.csdn.net/weixin_42312310/article/details/114654167)
- [Hive数据表删除数据操作](https://blog.csdn.net/weixin_42011858/article/details/125597965)

hive 表删除部分数据不支持使用 Delete From table_name where ...语句，hive表删除数据要分为不同的粒度：table、partition、partition内。
...
- [HIVE数据的压缩与存储格式](https://blog.csdn.net/meng_xin_true/article/details/126060603)
...
- [大数据开发之Hive优化篇5-使用ORC文件格式优化Hive](https://zhuanlan.zhihu.com/p/445498581)
...
- [Hive与HBase之间的区别和联系](https://blog.csdn.net/m0_55868614/article/details/121147275)
...
- [大数据组件之Hive（Hive学习一篇就够了）_](https://blog.csdn.net/m0_43405302/article/details/123293462)
...
- [hive优化大全（hive的优化这一篇就够了）](https://blog.csdn.net/m0_43405302/article/details/123375622)
