- [Hive的dws层建表语句及加载数据_大数据翻身的博客-CSDN博客_dws建表语句](https://blog.csdn.net/qq_56870570/article/details/120330580?spm=1001.2014.3001.5502)
...
3）[struct](https://so.csdn.net/so/search?q=struct&spm=1001.2101.3001.7020)结构数据定义

struct<id:int,name:string,age:int>

4）struct和array[嵌套](https://so.csdn.net/so/search?q=嵌套&spm=1001.2101.3001.7020)定义
...
（1）在/home/muzili/bin目录下创建脚本dwd_to_dws.sh
...
[muzili@hadoop102 bin]$ chmod +x dwd_to_dws.sh

（3）执行脚本

[muzili@hadoop102 bin]$ dwd_to_dws.sh all 2021-09-16
